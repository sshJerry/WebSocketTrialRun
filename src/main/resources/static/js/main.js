...
function onError() {
    connectingElement.textContent = "Could not connect to websocket. Please refresh and try again!";
...
function onMessageReceived(payload) {
    ...
    if(message.type === 'CONNECTING') {
        ...
        messageElement.classList.add('event-message');
        message.content = message.sender + ' has disconnected!';
    } else {
...
function sendMessage(event) {
    ...
    if (messageContent && stompClient) {
        console.log("Both Message Content and StompClient are true");
